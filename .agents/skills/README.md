...
> 项目核心指导文件为根目录 [`AGENT.md`](../../AGENT.md)，所有 Agent 工作前应先读。本目录的 skills 是 AGENT.md "经验沉淀机制" 的落地:可复用的多步操作流程写成 `<名字>/SKILL.md`,项目级约定写入 AGENT.md。
...
| `save-lesson` | 会话经验分流沉淀到 AGENT.md / skills / memory    |
